...
#include "ke_timer.h"
#include "app_wechat.h"              // Application security Definition
...
{
    (appm_add_svc_func_t)app_wechat_add_wechat,
    ...
    {				
...
#endif                    
        {
            ...
            memcpy(&cmd->info.host.adv_data[cmd->info.host.adv_data_len],
                   APP_WECHAT_ADV_DATA_UUID, APP_WECHAT_ADV_DATA_UUID_LEN);
            cmd->info.host.adv_data_len += APP_WECHAT_ADV_DATA_UUID_LEN;
        }
...
#endif                    
        {
            cmd->info.host.scan_rsp_data_len = 0;
          	...
          	cmd->info.host.scan_rsp_data[cmd->info.host.scan_rsp_data_len++] = 0x09;
			cmd->info.host.scan_rsp_data[cmd->info.host.scan_rsp_data_len++] = 0xff;//Manufacturer Specific Data
			cmd->info.host.scan_rsp_data[cmd->info.host.scan_rsp_data_len++] = 0x00;
			cmd->info.host.scan_rsp_data[cmd->info.host.scan_rsp_data_len++] = 0x00;
			cmd->info.host.scan_rsp_data[cmd->info.host.scan_rsp_data_len++] = co_default_bdaddr.addr[5];
			cmd->info.host.scan_rsp_data[cmd->info.host.scan_rsp_data_len++] = co_default_bdaddr.addr[4];
			cmd->info.host.scan_rsp_data[cmd->info.host.scan_rsp_data_len++] = co_default_bdaddr.addr[3];
			cmd->info.host.scan_rsp_data[cmd->info.host.scan_rsp_data_len++] = co_default_bdaddr.addr[2];
			cmd->info.host.scan_rsp_data[cmd->info.host.scan_rsp_data_len++] = co_default_bdaddr.addr[1];
			cmd->info.host.scan_rsp_data[cmd->info.host.scan_rsp_data_len++] = co_default_bdaddr.addr[0];
        }
