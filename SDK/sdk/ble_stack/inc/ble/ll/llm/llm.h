...
#ifdef CFG_SCAN_ADV_SYNC    
    struct ea_elt_tag *adv_elt;
    struct ea_elt_tag *scan_elt;
#endif    
    ///encryption pending
    bool enc_pend;
...
#define LLM_ADV_INTERVAL_MIN                    8//(0x20)
...
#define LLM_ADV_INTERVAL_MIN_NONCON_DISC        8    //160 //(0xA0)
