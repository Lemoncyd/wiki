...
#define MASTER_CON_NUM  3
#define SLAVE_CON_NUM 4

#if ((MASTER_CON_NUM+SLAVE_CON_NUM)>BLE_CONNECTION_MAX)
	#error "Number of connections over"
#endif 
...
/// Use 32K Hz Clock if HZ32000 set to 1 else 32,768k is used
...
#define RWIP_HEAP_DB_SIZE          (  BLEHL_HEAP_DB_SIZE_+1024  )
