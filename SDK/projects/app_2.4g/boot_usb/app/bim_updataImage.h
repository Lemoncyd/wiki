...
#define SEC_IMAGE_RUN_CADDR                  (0x4b60)///==(BOOT_MAX_SIZE/272+1)*256
#define SEC_IMAGE_RUN_APP_FADDR              (0x280B0)
#define SEC_IMAGE_RUN_STACK_FADDR            (0x20F0) /////==(BOOT_MAX_SIZE/272+1)*272
#define SEC_IMAGE_OAD_HEADER_APP_FADDR       (0x280A0)
#define SEC_IMAGE_OAD_HEADER_STACK_FADDR     ((SEC_IMAGE_RUN_CADDR*34/32)-0x10) /////==(BOOT_MAX_SIZE/272+1)*272-0x10
...
#define SEC_PART_IMAGE_ALLOC_END_FADDR           (0x52000) //(256KB)
#define SEC_PART_BACKUP_OAD_HEADER_FADDR         (0x52000) //256kb * 1024
#define SEC_PART_BACKUP_OAD_IMAGE_FADDR          (0x52010) //256kb * 1024 + 0X10
#define OAD_APP_PART_UID                    (0x42424242)
#define OAD_APP_STACK_UID                   (0x53535353)
#define SEC_OAD_RUN_APP_FADDR            ((SEC_IMAGE_RUN_CADDR*34/32)-0x10) // /////5016
