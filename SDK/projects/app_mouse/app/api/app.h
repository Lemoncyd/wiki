...
#define APP_DFLT_ADV_DURATION        (6000)
...
enum app_nvds_tag
{
    ...
    /// Peer device addr type
    NVDS_TAG_PEER_ADDR_TYPE             = 0xA2,
    NVDS_LEN_PEER_ADDR_TYPE             = 1,
};
#endif // (NVDS_SUPPORT)
