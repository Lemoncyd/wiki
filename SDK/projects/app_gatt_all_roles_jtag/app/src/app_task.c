                                             ...
                                             ke_task_id_t const src_id)
{
    ...
    if ((app_env.adv_state == APP_ADV_STATE_STARTED) && (p_param->actv_type == GAPM_ACTV_TYPE_ADV)&&(app_env.adv_actv_idx==p_param->actv_idx))
    {
    ...
    else if ((app_env.mesh_adv_state == APP_MESH_ADV_STATE_STARTED) && (p_param->actv_type == GAPM_ACTV_TYPE_ADV)&&(app_env.mesh_adv_actv_idx==p_param->actv_idx))
    {
        ...
        case (GAPM_START_ACTIVITY)://0xA4
        {
            if(param->status == GAP_ERR_NO_ERROR)
            {
                if(app_env.adv_state == APP_ADV_STATE_STARTING)
                {
                    ...
                    appm_mesh_update_adv_state(true);
                }
