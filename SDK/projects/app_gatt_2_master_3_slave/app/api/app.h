...
//#define APP_CONN_STABILITY_TEST

#define MASTER_CONN_MAX                     (2)
#define SLAVE_CONN_MAX                      (3)

#if (SLAVE_CONN_MAX < 1)
    #error("slave max connection has to be greater than 0");
#endif

#if ((MASTER_CONN_MAX + SLAVE_CONN_MAX) > BLE_CONNECTION_MAX)
    #error("master or slave max connection is overflow");
#endif
/*
 * TYPE DEFINITIONS
 ****************************************************************************************
