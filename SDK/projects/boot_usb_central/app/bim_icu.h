...
#define SYS_REG0X0                                           *((volatile unsigned long *) (BASEADDR_SYS+0x0*4))
#define POS_SYS_REG0X0_JTAG_MODE                             9
#define POS_SYS_REG0X0_RAM_RENT                              1
#define POS_SYS_REG0X0_PWR_SAVE                              0
#define SYS_REG0X1                                           *((volatile unsigned long *) (BASEADDR_SYS+0x1*4))
#define POS_SYS_REG0X1_GOTO_SLEEP                                1
#define POS_SYS_REG0X1_CPU_PWD                                   0
#define SYS_REG0X2                                           *((volatile unsigned long *) (BASEADDR_SYS+0x2*4))
...
#define POS_SYS_REG0X12_INT_ADC_STA                              8
...
#define MCU_CLK_40M   3
#define MCU_CLK_48M   4
#define MCU_CLK_64M   5
#define MCU_CLK_80M   6
