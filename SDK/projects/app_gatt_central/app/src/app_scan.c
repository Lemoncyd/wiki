...
static void appm_start_scaning(void)
{
    ...
    if (app_env.scan_state == APP_SCAN_STATE_CREATED)
    {
	    ...
	    p_cmd->u_param.scan_param.prop = GAPM_SCAN_PROP_PHY_CODED_BIT| GAPM_SCAN_PROP_ACTIVE_CODED_BIT;//| GAPM_SCAN_PROP_ACTIVE_1M_BIT;
        p_cmd->u_param.scan_param.scan_param_coded.scan_intv = 20;//app_env.scan_intv;
        p_cmd->u_param.scan_param.scan_param_coded.scan_wd = 4;//app_env.scan_wd;
#else		
