...
#define SDP_NB_CHAR_INSTANCES_MAX         (30)
...
{
    ///data
    uint8_t notify_mouse[1+12];
    uint8_t notify_standard_key[1+16];
    uint8_t notify_media_key[1+2];
    uint8_t notify_power_key[1+1];
    uint8_t notify_sensor[1+18];
    uint8_t notify_voice[1+64];
    ///Status
    uint8_t notify_mouse_status;
    uint8_t notify_standard_key_status;
    uint8_t notify_media_key_status;
    uint8_t notify_power_key_status;
    uint8_t notify_sensor_status;
    uint8_t notify_voice_status;
    uint8_t notify_voice_write;
    uint8_t notify_voice_read;
