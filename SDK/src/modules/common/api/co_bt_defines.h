...
#define ADV_INTERVAL_MIN    0x0004 //(2.5 ms)
#define ADV_INTERVAL_MIN_mouse    0x0001 //( ms)
...
/// Size of ACAD Data for ICL stream info - Not Encrypted
#define BLE_EXT_ACAD_ICL_STREAM_INFO_LEN     (28)
/// Size of ACAD Data for ICL stream info - Encrypted
/// AD Type reserved for Stream info ACAD data
/// TODO [FBE] put 0x29 for the moment
#define BLE_EXT_ACAD_ICL_STREAM_INFO_AD_TYPE (0x29)
#define BLE_EXT_ACAD_ICL_STREAM_INFO_ENC_LEN (57)
...
enum ble_adi
{
    ...
    BLE_ADI_DID_MASK        = 0x0FFF,//!< BLE_ADI_DID_MASK
    BLE_ADI_DID_LSB         = 0,     //!< BLE_ADI_DID_LSB
    // Advertising Set ID (SID)
    BLE_ADI_SID_MASK        = 0xF000,//!< BLE_ADI_SID_MASK
    BLE_ADI_SID_LSB         = 12,    //!< BLE_ADI_SID_LSB
};
