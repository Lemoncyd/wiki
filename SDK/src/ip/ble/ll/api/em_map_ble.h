...
/*
 ...
 #define EM_BLE_ADVDATATXBUF_NB        (BLE_ADV_BUF_NB_TX+2)
 ...
 */
#define EM_BLE_ISO_DESC_OFFSET                CO_ALIGN4_HI(EM_BLE_ACLTXBUF_END)
...
#define EM_BLE_RX_CTE_DESC_OFFSET      CO_ALIGN4_HI(EM_BLE_ISO_BUFFER_END)
 ...
 ****************************************************************************************
 */
/// Area definition for antenna IDs
#define EM_BLE_ANTENNA_ID_OFFSET      CO_ALIGN4_HI(EM_BLE_RX_CTE_DESC_END)
#if (BLE_AOA | BLE_AOD)
#define EM_BLE_ANTENNA_ID_NB          (BLE_ANTENNA_NB)
#define EM_BLE_ANTENNA_ID_END         (EM_BLE_ANTENNA_ID_OFFSET + BLE_ANTENNA_NB)
#else // (BLE_CON_CTE_REQ | BLE_CONLESS_CTE_RX)
#define EM_BLE_ANTENNA_ID_END         (EM_BLE_ANTENNA_ID_OFFSET)
#endif // (BLE_CON_CTE_REQ | BLE_CONLESS_CTE_RX)
