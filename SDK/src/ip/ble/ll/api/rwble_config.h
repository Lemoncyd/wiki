...
/******************************************************************************************/
/// Features byte 0
#define BLE_FEATURES_BYTE0_MOUSE  (  (1 << BLE_FEAT_ENC    )| (1 <<BLE_FEAT_EXT_REJ_IND    ))
\
...
/// Features byte 1
#define BLE_FEATURES_BYTE1_MOUSE  (0)
                            /*(  (BLE_PHY_2MBPS_SUPPORT         << (
BLE_FEAT_2M_PHY            - 8) ) \
                             | (BLE_STABLE_MOD_IDX_TX_SUPPORT << (
BLE_FEAT_STABLE_MOD_IDX_TX - 8) ) \
                             | (BLE_STABLE_MOD_IDX_RX_SUPPORT << (
BLE_FEAT_STABLE_MOD_IDX_RX - 8) ) \
                             | (BLE_PHY_CODED_SUPPORT         << (
BLE_FEAT_CODED_PHY         - 8) ) \
                             | (1                             << (
BLE_FEAT_EXT_ADV           - 8) ) \
                             | (1                             << (
BLE_FEAT_PER_ADV           - 8) ) \
                             | (1                             << (
BLE_FEAT_CHAN_SEL_ALGO_2   - 8) ) \
                             | (1                             << (
BLE_FEAT_PWR_CLASS_1       - 8) )
                             )*/

/// Features byte 1
#define BLE_FEATURES_BYTE11_MOUSE  (0)
                            /*(  (0                            << (
BLE_FEAT_2M_PHY            - 8) ) \
                             | (BLE_STABLE_MOD_IDX_TX_SUPPORT << (
BLE_FEAT_STABLE_MOD_IDX_TX - 8) ) \
...
/// Features byte 2
#define BLE_FEATURES_BYTE2_MOUSE  (0)
                            /*(  (1                                      << (
BLE_FEAT_MIN_NUM_USED_CHAN_PROC - 16) ) \
                             | (BLE_CON_CTE_REQ                        << (
BLE_FEAT_CON_CTE_REQ            - 16) ) \
                             | (BLE_CON_CTE_RSP                        << (
BLE_FEAT_CON_CTE_RSP            - 16) ) \
                             | (BLE_CONLESS_CTE_TX                     << (
BLE_FEAT_CONLESS_CTE_TX         - 16) ) \
                             | (BLE_CONLESS_CTE_RX                     << (
BLE_FEAT_CONLESS_CTE_RX         - 16) ) \
                             | (BLE_AOD                                << (
BLE_FEAT_AOD                    - 16) ) \
                             | (BLE_AOA                                << (
BLE_FEAT_AOA                    - 16) ) \
                             | ((BLE_CON_CTE_REQ | BLE_CONLESS_CTE_RX) << (
BLE_FEAT_CTE_RX                 - 16) )
                             )*/

/// Features byte 3
#define BLE_FEATURES_BYTE3_MOUSE  (0)
                            /*(  (1 << (BLE_FEAT_PER_ADV_SYNC_TRANSF_TX - 24)
) \
...
/// Features byte 1
#define BLE_FEATURES_BYTE11  (  (0                            << (BLE_FEAT_2M_PHY            - 8) ) \
                             | (BLE_STABLE_MOD_IDX_TX_SUPPORT << (BLE_FEAT_STABLE_MOD_IDX_TX - 8) ) \
                             | (BLE_STABLE_MOD_IDX_RX_SUPPORT << (BLE_FEAT_STABLE_MOD_IDX_RX - 8) ) \
                             | (BLE_PHY_CODED_SUPPORT         << (BLE_FEAT_CODED_PHY         - 8) ) \
                             | (1                             << (BLE_FEAT_EXT_ADV           - 8) ) \
 ...
 */
#define BLE_HEAP_ENV_SIZE               (330*BLE_CENTRAL + 270*BLE_OBSERVER + BLE_ACTIVITY_MAX * 330)
...
#define BLE_ADV_FRAG_NB_TX           (2) // 5 sean change 2 2020.04.20
...
/// Low energy mask (should be a 4.0 value if device is on controller only)
#if ((BLE_EMB_PRESENT) && (!BLE_HOST_PRESENT))
#define BLE_EVT_MASK                {0x1C, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
...
#define BLE_CH_ASSESS_COUNT_MAX      80
...
#define BLE_CH_ASSESS_COUNT_THR_BAD  -9
/// Minimum counter value for channel assessment
#define BLE_CH_ASSESS_COUNT_MIN      -80
